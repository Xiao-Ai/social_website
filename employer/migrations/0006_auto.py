...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field applicants on 'Job'
        m2m_table_name = db.shorten_name(u'employer_job_applicants')
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field applicants on 'Job'
        db.delete_table(db.shorten_name(u'employer_job_applicants'))
